...
let candies = 20;
let people = 6;
let leftover = candies % people; // % means remainder after dividing 20 by 6. ( 20 mod 6) modulus
...
// The strings “true” or “false” are displayed on the console when a boolean variable is printed. 
//// my notes. || equals the word or.
//A true or false condition.  It is callled a boolean. 
// a numerical value cannot be assigned to a boolean variable 
// – only true or false, binary values on or off.
// % 2 Remainder after dividing by 2: either 0 or 1
// boolean for true or false my notes end.
...
function (fahrenheitToKelvin){
    return fahrenheitToKelvin(fakelvin)
} 
